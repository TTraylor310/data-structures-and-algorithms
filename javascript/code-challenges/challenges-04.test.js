...
const sortNames = (arr) => {
  let newPeople = arr.sort( (a,b) => a.toUpperCase() < b.toUpperCase() ? 1 : -1);
  return newPeople;
};
...
const alphabetize = (arr) => {
  let newA = arr.sort((a,b) => a.toUpperCase() < b.toUpperCase() ? 1 : -1);
  let newB =  newA.sort ((a,b) => a<b ? -1 : 1);
  return newB;
};
...
const sortByPrice = (arr) => {
  let newA = arr.sort ((a,b) => a.price < b.price ? -1:1);
  return newA;
};
